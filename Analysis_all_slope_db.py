...
for stock in stocks:
    ...
    for row_index, row_data in df3.iterrows():
        ...
        if (k < len_di):
            ...
            if not position:
                ...
                buy_qty = floor(start_value / df3.ix[k, 'Close'])
                Reg_Cross = df3.loc[k, 'Reg_5'] > df3.loc[k, 'Reg_10'] and df3.loc[k - 1, 'Reg_5'] <= df3.loc[
                    k - 1, 'Reg_10'] and df3.loc[k, 'Close'] > df3.loc[k, 'EMA_20']
                Reg_5_cond = df3.loc[k - 1, 'Reg_5_Pct'] < 0 or df3.loc[k - 2, 'Reg_5_Pct'] < 0 or df3.loc[
                    k - 3, 'Reg_5_Pct'] < 0
            ...
            #                     print('=====================================================================')
                ...
                if (df3.loc[k, 'Close'] < trail_price and stop_price < df3.loc[
                    k, 'Close'] and position and not trail_start):
                    #                     print('cond1',df3.loc[k, 'Close'], df3.loc[k-1, 'Close'],df3.loc[k, 'Date'],trail_price)
                    continue

                if (df3.loc[k, 'Low'] > trail_price and df3.loc[k, 'Close'] < df3.loc[
                    k - 1, 'Close'] and position and trail_start):
    ...
    df7 = df3[['Date', 'Open', 'High', 'Low', 'Close', 'Volume', 'Close_Chg', 'Reg_5', 'Reg_10', 'EMA_20', 'Signal_B',
               'Signal_SL', 'Signal_SP', 'PnL', 'Present_Value']]
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2014-1-1') & (df3['Date'] <= '2014-12-31')]
    # year_start = 100000
    # try:
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2015-1-1') & (df3['Date'] <= '2015-12-31')]
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2016-1-1') & (df3['Date'] <= '2016-12-31')]
    # year_start = df4['Portfolio_Value'][df4['Date'] == df4['Date'].min()].values[0]
    # year_end = df4['Portfolio_Value'][df4['Date'] == df4['Date'].max()].values[0]
    # profit = year_end - year_start
    # profit_perc = (year_end - year_start) / year_start * 100
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2017-1-1') & (df3['Date'] <= '2017-12-31')]
    # year_start = df4['Portfolio_Value'][df4['Date'] == df4['Date'].min()].values[0]
    # year_end = df4['Portfolio_Value'][df4['Date'] == df4['Date'].max()].values[0]
    # profit = year_end - year_start
    # profit_perc = (year_end - year_start) / year_start * 100
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2018-1-1') & (df3['Date'] <= '2018-12-31')]
    # year_start = df4['Portfolio_Value'][df4['Date'] == df4['Date'].min()].values[0]
    # year_end = df4['Portfolio_Value'][df4['Date'] == df4['Date'].max()].values[0]
    # profit = year_end - year_start
    # profit_perc = (year_end - year_start) / year_start * 100
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2019-1-1') & (df3['Date'] <= '2019-12-31')]
    # year_start = df4['Portfolio_Value'][df4['Date'] == df4['Date'].min()].values[0]
    # year_end = df4['Portfolio_Value'][df4['Date'] == df4['Date'].max()].values[0]
    # profit = year_end - year_start
    # profit_perc = (year_end - year_start) / year_start * 100
    ...
    #
    # df4 = df3[['Date', 'Symbol', 'Trade_Count', 'Profit_Trades', 'Loss_Trades', 'Portfolio_Value']][
    #     (df3['Date'] >= '2020-1-1') & (df3['Date'] <= '2020-7-9')]
    # year_start = df4['Portfolio_Value'][df4['Date'] == df4['Date'].min()].values[0]
    # year_end = df4['Portfolio_Value'][df4['Date'] == df4['Date'].max()].values[0]
    # profit = year_end - year_start
    # profit_perc = (year_end - year_start) / year_start * 100
