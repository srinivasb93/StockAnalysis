...
strategy = 'Reg_Latest_NIFTY_EMA20'
    ...
    for row_index, row_data in df3.iterrows():
        ...
        if (k < len_di):
            ...
            if not position:
                ...
                if ((df3.loc[k - 2, 'Close'] > df3.loc[k - 2, 'EMA_20'] and df3.loc[k - 1, 'Close'] > df3.loc[k - 1, 'EMA_20']) and \
                        (df3.loc[k, 'Low'] < df3.loc[k, 'EMA_20']) and (df3.loc[k, 'Close'] > df3.loc[k, 'EMA_20'])):
